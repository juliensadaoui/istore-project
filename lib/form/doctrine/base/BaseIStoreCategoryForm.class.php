...
/**
 * IStoreCategory form base class.
 *
 * @method IStoreCategory getObject() Returns the current form's model object
 *
 * @package    i-store
 * @subpackage form
 ...
 */
abstract class BaseIStoreCategoryForm extends BaseFormDoctrine
{
