 ...
 * @method IStoreOrder   getOrder()    Returns the current record's "Order" value
 * @method IStoreAddress setUserId()   Sets the current record's "user_id" value
 * @method IStoreAddress setOrderId()  Sets the current record's "order_id" value
 ...
 * @method IStoreAddress setOrder()    Sets the current record's "Order" value
 * 
 * @package    i-store
 * @subpackage model
...
abstract class BaseIStoreAddress extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasOne('IStoreOrder as Order', array(
             'local' => 'order_id',
             'foreign' => 'id'));
